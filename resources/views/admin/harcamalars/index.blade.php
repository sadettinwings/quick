...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-Harcamalar">
                <thead>
                    <tr>
                        <th width="10">
                    ...
                    <tr>
                        ...
                        <td>
                            <select class="search">
                                ...
                                @foreach($harcama_kategorileris as $key => $item)
                                    <option value="{{ $item->hkategori }}">{{ $item->hkategori }}</option>
                                @endforeach
                            </select>
                        </td>
                        <td>
                            <select class="search">
                                <option value>{{ trans('global.all') }}</option>
                                @foreach($borclars as $key => $item)
                                    <option value="{{ $item->borc_aciklama }}">{{ $item->borc_aciklama }}</option>
                                @endforeach
                            </select>
                        </td>
                        <td>
...
@endcan
  ...
  let table = $('.datatable-Harcamalar:not(.ajaxTable)').DataTable({ buttons: dtButtons })
