...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-PersonelOdemeleri">
                <thead>
                    <tr>
                        <th width="10">
                    ...
                    <tr>
                        ...
                        <td>
                            <select class="search">
                                <option value>{{ trans('global.all') }}</option>
                                @foreach($personel_odeme_kategoris as $key => $item)
                                    <option value="{{ $item->pkategori }}">{{ $item->pkategori }}</option>
                                @endforeach
                            </select>
                        </td>
                        <td>
...
@endcan
  ...
  let table = $('.datatable-PersonelOdemeleri:not(.ajaxTable)').DataTable({ buttons: dtButtons })
